...
bakeries = [
    "동탄 장미베이커리", "단대오거리 윤슬제과", "야탑 카페 파트너스", "분당 르분당",
    "동탄 봄밀베이커리", "성균관대 플렁드", "양재 이너피스베이커리", "양재 크레미엘",
    "안국 아티스트베이커리", "광안리 에브리도우"
]
...
with open("naver_links_61_70.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

print("Saved to naver_links_61_70.json")
